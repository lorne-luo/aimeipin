    ...
    <link rel="stylesheet" type="text/css" href="${PATH}/css/common.css?v=${version}"/>

    <script type="text/javascript" src="${PATH}/js/jquery-1.11.2.min.js"></script>
    <script type="text/javascript" src="${PATH}/js/common.js?v=${version}"></script>
    ...
    <script type="text/javascript" src="${PATH}/js/constants.js?v=${version}"></script>
